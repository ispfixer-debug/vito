package com.vito.admin.viewmodel
...
class AdminAuthViewModel @Inject constructor(
    ...
    private val _authState = MutableStateFlow(AdminAuthState())
        ...
        viewModelScope.launch {
            ...
            authRepository.signInWithCustomToken("demo").fold(
                onSuccess = { user ->
                    ...
                    _authState.update { it.copy(isLoading = false, user = adminUser, isLoggedIn = true) }
                },
                onFailure = { e ->
    ...
    fun logout() {
        viewModelScope.launch {
            ...
            _authState.update { AdminAuthState() }
        }
    }
}